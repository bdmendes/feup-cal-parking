...
TEST(adjacencyMatrix, simpleGraph){
    Graph<int> g1;
    auto n1 = g1.addNode(1, 1);
    auto n2 = g1.addNode(2, 2);
    auto n3 = g1.addNode(3, 3);
    ...
    std::vector<std::vector<double>> m = {
            ...
            {UINT32_MAX, UINT32_MAX, 1, 2, UINT32_MAX},
            {UINT32_MAX, UINT32_MAX, UINT32_MAX, 4, 2},
            {UINT32_MAX, UINT32_MAX, 2, UINT32_MAX, 2},
            {UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX}
    };
    EXPECT_EQ(g1.getAdjacencyMatrix(), m);
}
